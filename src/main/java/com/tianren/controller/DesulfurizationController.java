...
@Controller
@RequestMapping("/desulfurization")
public class DesulfurizationController {
    ...
    public String getRealTimeData(HttpServletRequest request, HttpSession session) {
        ...
        Result<Map<String, List<String>>> dataConfig = commonService.getDataConfig("desulfurization");

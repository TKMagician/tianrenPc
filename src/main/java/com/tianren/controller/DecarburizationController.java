...
@Controller
@RequestMapping("/decarburization")
public class DecarburizationController {
    ...
    public String getRealTimeData(HttpServletRequest request, HttpSession session) {
        ...
        Result<Map<String, List<String>>> dataConfig = commonService.getDataConfig("decarburization");
